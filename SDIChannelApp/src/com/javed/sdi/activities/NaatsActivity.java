...
@SuppressLint("NewApi")
public class NaatsActivity extends Activity {
	// Log tag
	...
	private String speakername="Qari Rizwan";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapter = new CustomListAdapter(this, videoList);
		 ...
		 url = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&playlistId="+"PLRQaPRCyhXpcHHBNHCQ2vDfE6KdhWAX06"+"&key=AIzaSyCOMLqATGL5jS_UAp79mBkpzf-lN58y0R0&maxResults=50";
