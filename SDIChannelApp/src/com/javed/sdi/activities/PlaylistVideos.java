...
public class PlaylistVideos extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapter = new CustomListAdapter(this, videoList);
		 ...
		 Intent in = getIntent();
		 url = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&playlistId="+in.getStringExtra("playlist_id")+"&key=AIzaSyCOMLqATGL5jS_UAp79mBkpzf-lN58y0R0&maxResults=50";
	     speakername=in.getStringExtra("name");
